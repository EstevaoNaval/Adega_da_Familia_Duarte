...
<body>
    ...
    <section>
        <div class="container">
            <div class="card border border-light text-center my-5" id="setCardPadrao">
                <div class="card-header border border-light">
                    <h1 class="display-4">Editar vinho</h1>
                </div>
                <div class="card-body border border-light">
                    ...
                    <form action="editarVinho.php?id=<?php echo $ID;?>" enctype="multipart/form-data" method="POST" id="formEdicaoVinho">
                        <div class="form-group mx-auto row">
                            <label class="col-lg-4 col-md-4 col-sm-12 ml-auto"><h3>Nome </h3></label>
                            <input type="text" name="edicaoVinhoNome" class="form-control col-lg-4 col-md-4 col-sm-12 rounded-pill mr-auto border border-dark" required placeholder="Insira o nome do vinho" value="<?php echo $DadosVinho["NomeCompletoVinho"];?>">
                        </div>
                        <div class="form-group mx-auto row">
                            <label class="col-lg-4 col-md-4 col-sm-12 ml-auto"><h3>Tipo </h3></label>
                            <input type="text" name="edicaoVinhoTipo" class="form-control col-lg-4 col-md-4 col-sm-12 rounded-pill mr-auto border border-dark" required placeholder="Insira o tipo de vinho" value="<?php echo $DadosVinho["TipoVinho"];?>">
                        </div>
                        <div class="form-group mx-auto row">
                            <label class="col-lg-4 col-md-4 col-sm-12 ml-auto"><h3>Uva </h3></label>
                            <input type="text" name="edicaoVinhoUva" class="form-control col-lg-4 col-md-4 col-sm-12 rounded-pill mr-auto border border-dark" required placeholder="Insira a uva usada" value="<?php echo $DadosVinho["Uva"];?>">
                        </div>
                        <div class="form-group mx-auto row">
                            <label class="col-lg-4 col-md-4 col-sm-12 ml-auto"><h3>Volume (mL ) </h3></label>
                            <input type="text" name="edicaoVinhoVolume" class="form-control col-lg-4 col-md-4 col-sm-12 rounded-pill mr-auto border border-dark" required placeholder="Insira qual o volume do vinho" value="<?php echo $DadosVinho["Volume"];?>">
                        </div>
                        <div class="form-group mx-auto row">
                            <label class="col-lg-4 col-md-4 col-sm-12 ml-auto"><h3>Safra </h3></label>
                            <input type="text" name="edicaoVinhoAnoComposicao" class="form-control col-lg-4 col-md-4 col-sm-12 rounded-pill mr-auto border border-dark" minlength="4" maxlength="4" required placeholder="Insira o ano de produção do vinho" pattern="[0-9]{4}" value="<?php echo $DadosVinho["AnoComposicao"]?>">
                        </div>
                        <div class="form-group mx-auto row">
                            <label class="col-lg-4 col-md-4 col-sm-12 ml-auto"><h3>Origem </h3></label>
                            <input type="text" name="edicaoVinhoOrigem" class="form-control col-lg-4 col-md-4 col-sm-12 rounded-pill mr-auto border border-dark" required placeholder="Insira o país de origem" value="<?php echo $DadosVinho["Origem"]?>">
                        </div>
                        <div class="form-group mx-auto row">
                            <label class="col-lg-4 col-md-4 col-sm-12 ml-auto"><h3>Região </h3></label>
                            <input type="text" name="edicaoVinhoRegiao" class="form-control col-lg-4 col-md-4 col-sm-12 rounded-pill mr-auto border border-dark" required placeholder="Insira a região de origem" value="<?php echo $DadosVinho["Regiao"]?>">
                        </div>
                        <div class="form-group mx-auto row">
                            <label class="col-lg-4 col-md-4 col-sm-12 ml-auto"><h3>Vinícola </h3></label>
                            <input type="text" name="edicaoVinhoVinicola" class="form-control col-lg-4 col-md-4 col-sm-12 rounded-pill mr-auto border border-dark" required placeholder="Insira a produtora de origem" value="<?php echo $DadosVinho["Vinicola"]?>">
                        </div>
                        <div class="form-group mx-auto row">
                            <label class="col-lg-4 col-md-4 col-sm-12 ml-auto"><h3>Teor alcoólico </h3></label>
                            <input type="text" name="edicaoVinhoTeorAlcoolico" class="form-control col-lg-4 col-md-4 col-sm-12 rounded-pill mr-auto border border-dark" required placeholder="Ex.: 19.45" pattern="[\d,.]*" value="<?php echo $DadosVinho["TeorAlcoolico"]?>">
                        </div>
                        <div class="form-group mx-auto row">
                            <label class="col-lg-4 col-md-4 col-sm-12 ml-auto"><h3>Temperatura de consumo </h3></label>
                            <input type="text" name="edicaoVinhoTempConsumo" class="form-control col-lg-4 col-md-4 col-sm-12 rounded-pill mr-auto border border-dark" required placeholder="Insira a temperatura de consumo do vinho" value="<?php echo $DadosVinho["TempConsumo"]?>">
                        </div>
                        <div class="form-group mx-auto row">
                            <label class="col-lg-4 col-md-4 col-sm-12 ml-auto"><h3>Preço (R$) </h3></label>
                            <input type="text" name="edicaoVinhoPreco" class="form-control col-lg-4 col-md-4 col-sm-12 rounded-pill mr-auto border border-dark" required placeholder="Ex.: 120.25" pattern="[\d,.]*" value="<?php echo $DadosVinho["Preco"]?>">
                        </div>
                        <div class="file-field row">
                            <input type="file" class="rounded-pill ml-auto col-9" name="edicaoVinhoImg" onchange="previewImagem()" id="edicaoVinhoImg" value="vazio"><br><br>
			                <img style="width: 350px;" src="<?php echo $DadosVinho["Imagem"];?>" name="preView" class="rounded border border-dark mx-auto">
                        </div>
                        
                </div>
                <div class="card-footer border border-light">
                    <input type="submit" name="btnEditarVinho" class="btn btn-outline-light mx-auto col-6 rounded-pill" value="Salvar mudanças" onclick="verificarArqvVazio()">
                    </form>
                </div>
            </div>
        </div>
    ...
    <script>
        function previewImagem(){
            var imagem = document.querySelector('input[name=edicaoVinhoImg]').files[0];
			var preview = document.querySelector('img[name=preView]');
				
            var reader = new FileReader();
            
            var inputFile = document.querySelector("#edicaoVinhoImg");
            inputFile.setAttribute("value","preenchido");
        ...
        function verificarArqvVazio(){
            var inputFile = document.querySelector("#edicaoVinhoImg");
            var formEdicaoVinho = document.querySelector("#formEdicaoVinho");

            if(inputFile.getAttribute("value") == "vazio"){
                formEdicaoVinho.setAttribute("action","editarVinho.php?id=<?php echo $ID;?>&ehVazio=sim");
                formEdicaoVinho.submit();
            }else{
                formEdicaoVinho.setAttribute("action","editarVinho.php?id=<?php echo $ID;?>&ehVazio=nao");
                formEdicaoVinho.submit();
            }
        }
    </script>
